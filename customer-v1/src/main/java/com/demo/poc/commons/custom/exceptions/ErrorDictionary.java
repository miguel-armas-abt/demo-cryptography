...
public enum ErrorDictionary {
    ...
    CUSTOMER_NOT_FOUND("01.01.02", "The customer doesn't exist", BUSINESS, NOT_FOUND, CustomerNotFoundException.class),
    INVALID_DOCUMENT_TYPE("01.01.03", "The document type is not defined", BUSINESS, BAD_REQUEST, InvalidDocumentTypeException.class),
    CUSTOMER_ALREADY_EXISTS("01.01.04", "The customer already exists", BUSINESS, BAD_REQUEST, CustomerAlreadyExistsException.class),
    CRYPTOGRAPHY_RESPONSE_NULL("01.01.05", "Cryptography response is null", SYSTEM, CONFLICT, CryptographyResponseNullException.class);
